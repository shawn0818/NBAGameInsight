...
class VideoAsset(BaseModel):
    ...
    - uuid: NBA 返回的视频唯一标识
    - qualities: 不同清晰度的视频信息（如 'sd', 'md', 'hd'）
    """
    event_id: str
    uuid: str
...
class VideoResponse(BaseModel):
    ...
    def get_total_videos(self) -> int:
        """获取视频总数"""
        video_assets = self.resultSets.get('video_assets', {})
        return len(video_assets)

    def get_videos(self) -> Dict[str, VideoAsset]:
        """获取所有视频资产"""
        return self.resultSets.get('video_assets', {})
